...
const addNote = (req, res, next) => {
  ...
  if (!title || !content) {
    logger.warn({ userId }, "Create note failed - missing fields");
...
const getNotes = (req, res, next) => {
  ...
  logger.info({ userId }, "Fetch notes attempt");
  ...
  getNotesByUserId(userId, (err, result) => {
    ...
    logger.info(
      { userId, totalNotes: result.length },
...
const updateUserNote = (req, res, next) => {
  ...
  logger.info({ userId, noteId }, "Update note attempt");
...
const deleteUserNote = (req, res, next) => {
  ...
  logger.info({ userId, noteId }, "Delete note attempt");
